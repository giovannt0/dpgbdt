...
# Source code: https://github.com/google/cloud-forensics-utils/blob/master/
# libcloudforensics/logging_utils.py
# Modification notice: adapt code for the dpgbdt project, remove comments
# proper to libcloudforensics
